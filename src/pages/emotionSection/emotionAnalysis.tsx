...
const EmotionAnalysis: React.FC = ({history}: any) => {
	...
	return (
			<div id="capture" style={{height: "100vh", maxWidth: "450px"}}>
				<div className="container" style={{background: "#A6A998", width: "100%", height: "10%", display: "flex", justifyContent: "space-around", paddingTop: ".5rem"}}>
				...
				<div style={{backgroundColor:"#E8EDD5", width: "100%", height: "90%", maxWidth: "450px", }}> 
					<>
